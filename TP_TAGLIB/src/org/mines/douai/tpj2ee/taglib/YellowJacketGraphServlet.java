...
/**
 * Servlet implementation class YellowJacketGraphServlet
 */
@WebServlet(description = "YellowJacketGraph", urlPatterns = { "/YellowJacketGraph" })
public class YellowJacketGraphServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public YellowJacketGraphServlet() {
        super();
